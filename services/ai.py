...
Напиши персональный гороскоп дня от Бабушки AIda для {name}.
Длина ответа: максимум 600 символов. Это должна быть короткая выжимка, без длинного вступления.
Пиши только по-русски, без английских слов и технических терминов.
Учитывай знак зодиака и карту дня. Структура: настроение дня; на что обратить внимание; короткий совет.
...
async def get_soul_card_analysis(name: str, birthdate: str, calculation: dict, soul_card: dict) -> str:
    """Личная интерпретация карты судьбы после уже показанного расчёта."""
...
Расчёт уже показан пользователю цифрами над этим текстом. Не пересказывай арифметику, не объясняй, как складывали дату, и не повторяй шаги расчёта словами.
Дай готовый интересный результат по карте судьбы: что эта карта говорит о человеке, его внутреннем выборе, сильной стороне и живом совете.
Длина ответа: максимум 1300 символов. Никаких длинных полотен текста.
Пиши только по-русски, без английских слов и технических терминов.
Структура ответа:
1. Главный смысл карты — 3 короткие фразы.
2. Сильная сторона человека — 2 короткие фразы.
3. Где важно быть внимательнее — 1 короткая фраза.
4. Совет от Бабушки — 1 короткая фраза.
